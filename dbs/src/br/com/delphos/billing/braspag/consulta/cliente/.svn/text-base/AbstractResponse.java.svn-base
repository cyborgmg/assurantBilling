 ...
 *         &lt;element name="ErrorReportDataCollection" type="{https://www.pagador.com.br/query/pagadorquery}ArrayOfErrorReportDataResponse" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    OrderIdDataResponse.class,
    BoletoDataResponse.class,
    CreditCardDataResponse.class,
    AdditionalDataResponse.class,
    TransactionDataResponse.class,
    OrderDataResponse.class,
    BraspagOrderIdDataResponse.class,
    DeliveryAddressDataResponse.class,
    CustomerDataResponse.class,
    AdditionalTransactionDataResponse.class,
    OrderIdTransactionResponse.class
})
