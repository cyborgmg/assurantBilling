...
@WebService(endpointInterface = "br.com.delphos.billing.servicos.ServicoServer")
public class ServicoServerImpl implements ServicoServer {
		...
		public RetornoCancelarVenda cancelarVenda(String codigoEmpresa,
				...
				String cpf, String codigoVenda,
				String codigoMotivoCancelamento, String valorEstorno,
				String flagCancelamentoGateway) throws BillingException {
			// TODO Auto-generated method stub
			
			return getService().cancelarVenda(codigoEmpresa, codigoProduto, codigoSistema, token, cpf, codigoVenda, codigoMotivoCancelamento, valorEstorno, flagCancelamentoGateway);
		}
