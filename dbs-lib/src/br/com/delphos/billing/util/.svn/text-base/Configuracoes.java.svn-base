...
public class Configuracoes {
	...
	public static boolean isDebug() {
		return _getBooleanOuFalse(get("billing.debug"));
	}
	
	public static String get(String nomePropriedade, Object... args) {
		String mensagem = System.getProperty("billing.debug");
		if (mensagem == null) {
	...
	public static boolean getBooleanOuFalse(PropriedadeConfiguracao nomePropriedade) {
		return getBooleanOuFalse(nomePropriedade.getNomePropriedade());
	}

	public static Boolean getBoolean(PropriedadeConfiguracao nomePropriedade) {
		return getBoolean(nomePropriedade.getNomePropriedade());
	}
