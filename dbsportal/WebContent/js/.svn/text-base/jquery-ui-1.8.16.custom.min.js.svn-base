    ...
    d.extend(M.prototype,{
        ...
        _attachments:function(a,b){
            ...
            if(c=="button"||c=="both"){
                ...
                b.trigger=d(this._get(b,"buttonImageOnly")?d("<img class='IconeCalendario' />").addClass(this._triggerClass).attr({
                    src:f,
                    alt:c,
                    title:c
                //style: "position: absolute; " //DPH - ALINHAMENTO IMAGEM CALENDÁRIO
