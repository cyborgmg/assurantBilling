 ...
 * 2015-11-04T13:03:45.360-02:00
 * Generated source version: 2.7.17
 * 
 */
@WebServiceClient(name = "ServicoServerImplService", 
                  wsdlLocation = "file:/C:/desenv/Workspaces/assurantBilling/dbs-war/WebContent/wsdl/servicoserverimpl.wsdl",
...
public class ServicoServerImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/desenv/Workspaces/assurantBilling/dbs-war/WebContent/wsdl/servicoserverimpl.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServicoServerImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/desenv/Workspaces/assurantBilling/dbs-war/WebContent/wsdl/servicoserverimpl.wsdl");
        }
        WSDL_LOCATION = url;
    }
