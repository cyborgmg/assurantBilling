...
<body>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									...
									value="${ConfiguracaoActionForm.descricaoEmpresa}" maxlength="255" class="parametros"/>
								</td>
							</tr>
						</tbody>
					</table>
	...
	<script>
		...
		function incluir(){
			...
			document.pesquisaEmpresaForm.opcao.value = 'incluir';
        ...
        function executarExclusao(retorno) {                
            if (retorno){                  
                ...
                document.pesquisaEmpresaForm.action = "../configuracao/manterEmpresa.do?operacao=3";
                document.pesquisaEmpresaForm.submit();      
            }
        }
	</script>
