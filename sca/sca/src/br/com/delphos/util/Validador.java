...
public final class Validador {
	...
	/**
	 * Testa se uma String ap�s a retirada de espa�os em branco � nula ou est� vazia.
	 *
	 * @param campo
...
//		return campo == null || campo.trim().length() == 0;
     ...
     * @return
     */
    public static boolean temReferencias(Object o) {
        ...
        try {
            ...
            if (o != null) {
                ...
                for (int i = 0; i < fields.length; i++) {
                    ...
                    Object atributo = fields[i].get(o);
                    try {

                        if (atributo.getClass().getDeclaredField("id") != null) {
                    ...
                    if (atributo instanceof List && !atributo.toString().equals("{IndirectList: not instantiated}")) {
                        retorno = true;
                        break;
                    }
                }
